...
class OrderDataStore:
    def __init__(self, data_dir: Path, output_dir: Path, *, today: str | None = None) -> None:
        ...
        self.product_index = {product.product_id: product for product in self.products}
    ...
    def list_products(
        ...
        *,
        ...
        results: list[tuple[int, int, int, str, dict]] = []
        ...
        results.sort(key=lambda item: (-item[0], item[2], item[3]))
